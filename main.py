...
from core.kahnethar_jantri import JANTRI_COVERAGE_END as KAHN_END, JANTRI_COVERAGE_START as KAHN_START, get_empty_month_summaries as get_kahn_empty
from core.khandar_jantri import JANTRI_COVERAGE_END as KHANDAR_END, JANTRI_COVERAGE_START as KHANDAR_START, get_empty_month_summaries as get_khandar_empty
from core.mekhal_jantri import JANTRI_COVERAGE_END as MEKHAL_END, JANTRI_COVERAGE_START as MEKHAL_START, get_empty_month_summaries as get_mekhal_empty
from core.shishur_jantri import JANTRI_COVERAGE_END as SHISHUR_END, JANTRI_COVERAGE_START as SHISHUR_START, get_empty_month_summaries as get_shishur_empty
...
def calculate_muhurat(request: SaathRequest):
    ...
    if request.event_type == "kahnethar":
        ...
        c_start, c_end = SHISHUR_START, SHISHUR_END
    elif request.event_type == "gandan":
        c_start, c_end = GANDAN_START, GANDAN_END
    elif request.event_type == "pravesh":
        c_start, c_end = PRAVESH_START, PRAVESH_END
    else:
    ...
    while current_date <= end:
        ...
        if day_eval and day_eval.get("is_auspicious"):
